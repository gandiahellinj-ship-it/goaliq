...
const MUSCLE_GROUPS: Record<string, string[]> = {
  ...
  back:     ["Lats", "Trapezius", "Rhomboids", "Lower back", "Upper back",
             "Dorsales", "Trapecios", "Romboides", "Lumbares", "Espalda alta", "Traps", "Espalda",
             // v0.9.12 — added from catalog audit (Upper Back: 88, Spine: 19, Levator Scapulae: 2)
             "Upper Back", "Spine", "Columna", "Levator Scapulae", "Elevador escápula"],
  legs:     ["Quadriceps", "Hamstrings", "Glutes", "Calves", "Adductors",
             "Cuádriceps", "Isquiotibiales", "Glúteos", "Gemelos", "Aductores",
             "Quads", "Quad", "Glute", "Calf", "Abductores", "Abductors", "Piernas"],
  chest:    ["Upper chest", "Middle chest", "Lower chest",
             "Pectoral superior", "Pectoral medio", "Pectoral inferior",
             "Pectorals", "Pectoral", "Pecho", "Pectorales",
             // v0.9.12 — added from catalog audit (Serratus Anterior: 5)
