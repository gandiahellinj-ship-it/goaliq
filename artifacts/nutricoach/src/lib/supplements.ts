...
export interface SupplementTiming {
  options: { time: string; desc: string }[];
  tip: string;
}
...
export const SUPPLEMENT_TIMING: Record<string, SupplementTiming> = {
  proteina_polvo: {
    options: [
      { time: "⏱ Post-entreno",        desc: "Ventana anabólica de 30 min para maximizar síntesis muscular" },
      { time: "🌅 Con el desayuno",     desc: "Ideal si no entrenas por la mañana o en días de descanso" },
    ],
    tip: "La whey tiene el mayor valor biológico. Tómala en los 30 min después del entreno para activar la síntesis muscular.",
  },
  creatina: {
    options: [
      { time: "🏋️ Pre o post-entreno", desc: "La consistencia diaria importa más que el momento exacto" },
      { time: "🍽️ Con las comidas",    desc: "La insulina postprandial ayuda a su absorción celular" },
    ],
  ...
  vitamina_d: {
    options: [
      { time: "🍳 Con el desayuno",     desc: "Tómala con la comida más grasa del día para mejor absorción" },
      { time: "🥗 Con la comida",       desc: "La vitamina D es liposoluble — necesita grasas para absorberse" },
    ],
    tip: "Es liposoluble — se absorbe hasta 50% mejor con una comida con grasas saludables como aguacate o aceite de oliva.",
  },
  magnesio: {
    options: [
      { time: "🌙 Antes de dormir",     desc: "Mejora la calidad del sueño y la recuperación nocturna" },
      { time: "🍽️ Con la cena",        desc: "Reduce calambres musculares post-entrenamiento" },
    ],
  ...
  omega_3: {
    options: [
      { time: "🍽️ Con las comidas",        desc: "Reduce el sabor a pescado y mejora la absorción de EPA/DHA" },
      { time: "🥗 Con la comida principal", desc: "Junto a grasas naturales para máxima biodisponibilidad" },
    ],
    tip: "Mejora la absorción de EPA y DHA hasta un 40% tomándolo con comida. Busca mínimo 1g de EPA+DHA combinados.",
  },
  vitamina_c: {
    options: [
      { time: "🌅 Con el desayuno", desc: "Potencia la absorción de hierro de los alimentos" },
      { time: "🌙 Con la cena",     desc: "Antioxidante nocturno para recuperación celular" },
    ],
    tip: "Tomar vitamina C con alimentos ricos en hierro vegetal aumenta su absorción hasta 3 veces. Divide la dosis en 2 tomas.",
  },
  zinc: {
    options: [
      { time: "🌙 Antes de dormir", desc: "Optimiza la producción de testosterona durante el sueño" },
      { time: "⏰ En ayunas",       desc: "Mejor absorción sin competencia de otros minerales" },
    ],
  ...
  hierro: {
    options: [
      { time: "⏰ En ayunas",        desc: "Máxima absorción lejos de calcio y café" },
      { time: "🍊 Con vitamina C",   desc: "La vitamina C triplica la absorción del hierro no hemo" },
    ],
    tip: "Evita tomar hierro con café, té o lácteos — reducen su absorción hasta un 60%. La vitamina C es tu mejor aliada.",
  },
  colageno: {
    options: [
      { time: "⏱ Pre-entreno",  desc: "30 min antes con vitamina C activa la síntesis de colágeno" },
      { time: "🌅 En ayunas",   desc: "Máxima absorción de aminoácidos en estado de reposo" },
    ],
    tip: "Tomar colágeno con vitamina C antes del ejercicio potencia la síntesis en tendones y cartílagos hasta un 60%.",
  },
  vitamina_b: {
    options: [
      { time: "🌅 Con el desayuno", desc: "Activa el metabolismo energético para todo el día" },
      { time: "⏰ En ayunas",       desc: "Mejor absorción en estómago vacío, especialmente B12" },
    ],
  ...
  calcio: {
    options: [
      { time: "🍽️ Con las comidas", desc: "Máximo 500mg por toma para mejor absorción intestinal" },
      { time: "🌙 Con la cena",     desc: "El calcio nocturno puede mejorar la densidad ósea" },
    ],
    tip: "Divide la dosis en 2 tomas de máximo 500mg — el intestino no puede absorber más de una vez. Evita tomarlo con hierro.",
  },
  vitamina_a: {
    options: [
      { time: "🍳 Con el desayuno",     desc: "Liposoluble — se absorbe mejor con grasas en la comida" },
      { time: "🥗 Con la comida principal", desc: "Junto a aceite de oliva o aguacate para máxima absorción" },
    ],
    tip: "La vitamina A es liposoluble y se acumula en el organismo. No superes la dosis recomendada — el exceso puede ser tóxico.",
  },
  vitamina_e: {
    options: [
      { time: "🍽️ Con las comidas",      desc: "Liposoluble — requiere grasas dietéticas para absorberse" },
      { time: "🥗 Con la comida más grasa", desc: "Potente antioxidante que protege las células del daño oxidativo" },
    ],
  ...
  cafeina: {
    options: [
      { time: "⏱ 30-60 min pre-entreno", desc: "Pico de efecto en 45 min — máximo rendimiento en el entreno" },
      { time: "🌅 Por la mañana",         desc: "Evita tomarlo después de las 14h para no afectar el sueño" },
    ],
