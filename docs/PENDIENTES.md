...
**PRÓXIMA SESIÓN:** Elegir el siguiente frente con José. Candidatos: (a) rediseño del paso 5 del onboarding (modalidad de entreno — tarea funcional, necesita plan de punta a punta); (b) el "cambio de puerta" (paso 5 de la hoja de ruta: /vision como raíz, retirar la app antigua); (c) proyecto de imágenes de platos; (d) puntos 4-5 de la auditoría (dependencias y limpieza). Nada bloquea; decisión de prioridad de José.
